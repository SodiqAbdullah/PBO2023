...
class PemutarAudio:
    def __init__(self, root):
        ...
        self.play_button = Button(root, text="Putar", command=self.putar_audio, state="disabled")
        self.play_button.pack()

        self.stop_button = Button(root, text="Berhenti", command=self.berhenti_audio, state="disabled")
